...
source(Utils.getFilename("scripts/MR_Bale.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/MR_BaleWrapper.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/MR_Baler.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/MR_ForageWagon.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/MR_LoadTrigger.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/MR_RecoverVehicleEvent.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/MR_StrawBlower.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/MR_Tedder.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/MR_TensionBelts.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/MR_TurnOnVehicle.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/MR_VehicleConfigurationItemWheel.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/MR_Windrower.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/MR_WoodCrusher.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/MR_WorkArea.lua", g_currentModDirectory))
